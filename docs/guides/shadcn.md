---
title: Shadcn-Guide
description: Here you can find all the components available in the library and the installation procedures.
---
# Installation
## **Adding Components**
```bash
...
Multiple Components?
```bash
bunx --bun shadcn@latest add [component] [components...]
```
